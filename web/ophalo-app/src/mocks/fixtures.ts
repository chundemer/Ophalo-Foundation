...
export const mockRequestSummaries: KeepRequestSummary[] = [
  {
    ...
    customerEmail: null,
    originalSummary: { fullText: "Water heater making noise — possibly sediment buildup, wants service call scheduled" },
    ...
    actions: {
      quickActions: [
        ...
        },
        {
          ...
          countsFirstResponse: false,
          changesStatus: false,
          effectSummaryCode: "internal_note_only",
        },
      ],
    },
  },
  {
    ...
    originalSummary: { fullText: "HVAC not heating — thermostat set to 72 but house reads 58, filter checked and fine" },
    ...
    actions: {
      quickActions: [
        ...
        },
        {
          ...
          label: "Contact",
          visibility: "external_affordance",
          requiresVersion: true,
          executionMode: "modal",
          clearsAttention: false,
          countsFirstResponse: true,
          changesStatus: false,
          effectSummaryCode: "external_contact_only",
        },
        {
          code: "acknowledge_attention",
          ...
          countsFirstResponse: false,
          changesStatus: false,
          effectSummaryCode: "clears_attention",
        },
      ],
    },
  },
  {
    ...
    originalSummary: { fullText: "Requesting quote for replacement of 3 bathroom faucets and fixture upgrade" },
  ...
  },
  {
    ...
    originalSummary: { fullText: "Garage door springs broken — door won't open, car stuck inside" },
      ...
      quickActions: [
        {
          ...
          countsFirstResponse: false,
          changesStatus: false,
          effectSummaryCode: "opens_detail_feedback",
        },
        {
          code: "close_request",
          label: "Close request",
          ...
          countsFirstResponse: false,
          changesStatus: true,
          effectSummaryCode: "closes_request",
        },
      ],
    },
  },
  {
    ...
    customerEmail: null,
    originalSummary: { fullText: "Fence repair estimate — two sections leaning, gate off hinge" },
    lastCustomerActivityAtUtc: null,
    lastBusinessActivityAtUtc: null,
    createdAtUtc: "2026-06-30T09:30:00Z",
    updatedAtUtc: "2026-06-30T09:30:00Z",
    version: "mock-req-005-v1",
    isTerminal: false,
    isPostCloseFollowUp: false,
    feedbackWasResolved: null,
    feedbackReviewAgeBucket: null,
...
export const mockRequestDetails: Record<string, KeepRequestDetailResult> = {
  ...
  "mock-req-004": {
    ...
    readyToClose: { hasCustomerActivityAfterResolution: true },
    terminatedAtUtc: null,
    followUpOnDate: null,
    followUpOnReason: null,
    followUpOnNote: null,
