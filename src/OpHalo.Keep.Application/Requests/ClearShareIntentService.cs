    ...
    IClock clock)
{
    private static readonly string[] ValidMethods =
        ["sms_qr", "email", "whatsapp", "copy_message", "copy_link", "manual_other", "native_share", "manual_mark_shared"];
    ...
    private static readonly Error InvalidMethod =
        Error.Create("KeepRequest.ShareIntentInvalidMethod", "The provided share method is not valid. Allowed values: sms_qr, email, whatsapp, copy_message, copy_link, manual_other, native_share, manual_mark_shared.");
