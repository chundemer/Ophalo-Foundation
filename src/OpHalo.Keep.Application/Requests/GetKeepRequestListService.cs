    ...
    IKeepRequestListCursorProtector cursorProtector)
{
        ...
        string normalizedView)
    {
        ...
        var (rankingGroup, rankingOrder) = KeepRequestRankingAndActionsBuilder.ComputeRankingGroup(
            r, isPostClose, firstResponsePending, firstResponseOverdue, overdueBusinessWaiting,
            isDueOrOverdueFollowUpOn);

        var severity = KeepRequestRankingAndActionsBuilder.ComputeSeverity(r, isOverdue, isPostClose, firstResponsePending,
        ...
        var quickActions = KeepRequestRankingAndActionsBuilder.BuildQuickActions(r, canOperate, isPostClose, firstResponseOverdue, actionDecision);
        var contactActions = KeepRequestRankingAndActionsBuilder.BuildContactActions(r, canOperate, isPostClose, actionDecision);
