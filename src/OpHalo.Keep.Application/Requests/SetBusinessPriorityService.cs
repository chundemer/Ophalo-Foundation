...
public sealed record SetBusinessPriorityCommand(
    Guid RequestId,
    BusinessPriority? Priority,
    Guid ExpectedVersion);

public sealed class SetBusinessPriorityService(
    ...
    IClock clock)
{
    ...
    public async Task<Result<KeepRequestDetailResult>> ExecuteAsync(
        SetBusinessPriorityCommand command, CancellationToken ct = default)
    {
        ...
        var setResult = request.SetBusinessPriority(
            command.Priority,
            currentUser.UserId,
            actorDisplayName,
            nowUtc);
