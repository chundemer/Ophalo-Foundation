...
{
    /// <inheritdoc />
    public partial class S25aKeepSmsHandoffs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "keep_sms_handoffs",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_keep_sms_handoffs", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_keep_sms_handoffs_expires_at_utc",
                table: "keep_sms_handoffs",
                column: "expires_at_utc");

            migrationBuilder.CreateIndex(
                name: "ix_keep_sms_handoffs_handoff_token_hash",
                table: "keep_sms_handoffs",
